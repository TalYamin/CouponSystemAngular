...
import { ICoupon, IStartDate, IEndDate } from '../Coupons/ICoupon';
...
export class CompanyService {
  ...
  private BASE_URL = 'http://localhost:8080/CouponSystemREST/rest/company';
  ...
  updateCoupon(couponId:number, newEndDate:string, newPrice: number): Observable<IStatus> {
